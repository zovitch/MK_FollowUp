...
export var UpdateWithConfirmButton = function (props) {
    ...
    var _l = useUpdate(resource, { id: record === null || record === void 0 ? void 0 : record.id, data: data, meta: mutationMeta, previousData: record }, __assign({ onSuccess: onSuccess, onError: onError, onSettled: onSettled, mutationMode: mutationMode }, otherMutationOptions)), update = _l[0], isPending = _l[1].isPending;
    ...
    return (React.createElement(Fragment, null,
        ...
        React.createElement(Confirm, { isOpen: isOpen, loading: isPending, title: confirmTitle, content: confirmContent, translateOptions: {
                smart_count: 1,
