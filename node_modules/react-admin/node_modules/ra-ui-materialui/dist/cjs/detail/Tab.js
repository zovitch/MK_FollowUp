 ...
 */
var Tab = function (_a) {
    var children = _a.children, contentClassName = _a.contentClassName, context = _a.context, count = _a.count, className = _a.className, divider = _a.divider, icon = _a.icon, iconPosition = _a.iconPosition, label = _a.label, record = _a.record, _b = _a.spacing, spacing = _b === void 0 ? 1 : _b, _c = _a.syncWithLocation, syncWithLocation = _c === void 0 ? true : _c, value = _a.value, rest = __rest(_a, ["children", "contentClassName", "context", "count", "className", "divider", "icon", "iconPosition", "label", "record", "spacing", "syncWithLocation", "value"]);
