...
var FormTab = function (props) {
    ...
    var renderContent = function () { return (React.createElement(ra_core_1.FormGroupContextProvider, { name: value.toString() },
        React.createElement(material_1.Stack, __assign({ alignItems: "flex-start", style: hidden ? hiddenStyle : undefined, className: contentClassName, id: "tabpanel-".concat(value), "aria-labelledby": "tabheader-".concat(value), "aria-hidden": hidden || undefined }, rest), children))); };
