...
var DeleteWithUndoButton = function (props) {
    ...
    var _e = (0, ra_core_1.useDeleteWithUndoController)({
        record: record,
        resource: resource,
        redirect: redirect,
        onClick: onClick,
    ...
    return (React.createElement(Button_1.Button, __assign({ onClick: handleDelete, disabled: isPending, label: label, className: (0, clsx_1.default)('ra-delete-button', className), key: "button", color: color }, rest), icon));
};
